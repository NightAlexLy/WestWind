...
<aside class="main-sidebar">
	<section class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class="treeview">
				<a href="#">
					<i class="fa fa-envelope"></i> <span>Email</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span>
				</a>
				<ul class="treeview-menu">
					<li>
						<a target="navTab" href="${ctx}/admin/emailInfo/list">
					<i class="fa fa-inbox"></i> <span>Outbox</span>
				</a>
				</li>
				<!--<li>
			...
			<li>
				<a target="navTab" href="${ctx}/admin/dataDictionary/list">
					<i class="fa fa-folder"></i> <span>Data Dictionary</span> </i>
				</a>
			</li>
			...
			<li class="treeview">
				<a href="#">
					<i class="fa fa-credit-card-alt"></i> <span>Finance</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span>
				</a>
				<ul class="treeview-menu">
					<li>
						<a target="navTab" href="${ctx}/admin/finance/interest/index">
						<i class="fa fa-inbox"></i> <span>Compound 	Interest</span>
						</a>
					</li>
				</ul>
			</li>
			<li class="treeview">
				<a href="#">
					<i class="fa fa-eye"></i> <span>Tools</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span>
				</a>
				<ul class="treeview-menu">
					<li>
						<a target="navTab" href="${ctx}/admin/tools/calendar/index">
						<i class="fa fa-inbox"></i> <span>Calendar</span>
						</a>
					</li>
				</ul>
			</li>
...
<header class="main-header">
	<a href="${ctx}/admin/index" class="logo">
		...
		<span class="logo-lg"><b>West-Wind </b>LTE</span>
	</a>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu">
					<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
						<img src="dist/img/user2-160x160.jpg" class="user-image" alt="User Image"> <span class="hidden-xs">西风</span>
					</a>
					<ul class="dropdown-menu">
						<li class="user-header">
							<img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
							<p>
								西风 - 超级管理员 <small>2016-10 加入</small>
							</p>
						</li>
						<li class="user-body">
							<div class="row">
								<div class="col-xs-4 text-center">
									<a href="http://www.cnblogs.com/LuisYang/" target="_blank">Blog</a>
								</div>
								<div class="col-xs-4 text-center">
									<a href="https://github.com/NightAlexLy" target="_blank">GitHub</a>
								</div>
								<div class="col-xs-4 text-center">
									<a href="http://git.oschina.net/open_source" target="_blank">码云</a>
								</div>
							</div>
						</li>
