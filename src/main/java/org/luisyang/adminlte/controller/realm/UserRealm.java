package org.luisyang.adminlte.controller.realm;
...
import org.luisyang.adminlte.biz.UserBiz;
import org.luisyang.adminlte.util.Constants;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
		...
		if (result.isStatus()) {
			...
			SecurityUtils.getSubject().getSession().setAttribute(Constants.Session.CURRENT_USER, user);
